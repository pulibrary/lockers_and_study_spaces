...
RSpec.describe 'Locker Assignment Search', type: :feature, js: true do
  ...
  let(:locker_assignment1) { FactoryBot.create(:locker_assignment, locker_application: locker_application1) }
  let(:locker_assignment2) { FactoryBot.create(:locker_assignment, locker_application: locker_application2) }
