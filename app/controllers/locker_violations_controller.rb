...
class LockerViolationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @locker_violation.save
        ...
        format.html { redirect_to @locker_violation, notice: 'LockerViolation was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @locker_violation.update(locker_violation_params)
        format.html { redirect_to @locker_violation, notice: 'LockerViolation was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to locker_violations_url, notice: 'LockerViolation was successfully destroyed.' }
